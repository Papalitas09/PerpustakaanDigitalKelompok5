 <!-- Menu -->
            <nav class="p-4 md:hidden">
                <div class="space-y-1">
                    ...
                    <a hAref="" class="menu-item text-gray-600 rounded-lg p-3 hover:bg-gray-100 cursor-pointer flex items-center space-x-3 block">
        ...
        <div class="hidden lg:block w-64 bg-white shadow-lg min-h-screen">
            ...
            <nav class="p-4">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('riwayat.minjam.pengguna') }}" class="menu-item text-gray-600 rounded-lg p-3 hover:bg-gray-100 cursor-pointer flex items-center space-x-3 block">
                        <i class="fas fa-history w-5"></i>
                        <span>Riwayat Pinjaman</span>
                    </a>
